            ...
            if (collider.tag != "player") {
                if (collider.tag == "Miner") {
                    if (gameObject.name == "Bullet 1(Clone)") {
                        ...
                        GameObject.Find ("Ship1").GetComponent<ShipInput> ().time = GameObject.Find ("Ship1").GetComponent<ShipInput> ().time + 5000;
                        Destroy (gameObject);
                        ...
                        GameObject.Find ("Ship2").GetComponent<ShipInput2> ().time = GameObject.Find ("Ship2").GetComponent<ShipInput2> ().time + 5000;
                        Destroy (gameObject);
                        Destroy (collider.gameObject);
                    }
